...
import com.jhipsterpress.web.domain.Profile;
...
import com.jhipsterpress.web.repository.ProfileRepository;
import com.jhipsterpress.web.service.ProfileService;
import com.jhipsterpress.web.service.dto.ProfileDTO;
import com.jhipsterpress.web.service.mapper.ProfileMapper;
import com.jhipsterpress.web.web.rest.errors.ExceptionTranslator;
import com.jhipsterpress.web.service.dto.ProfileCriteria;
import com.jhipsterpress.web.service.ProfileQueryService;
...
public class ProfileResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllProfilesByCommentIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the profileList where comment equals to commentId
        defaultProfileShouldBeFound("commentId.equals=" + commentId);

        // Get all the profileList where comment equals to commentId + 1
        defaultProfileShouldNotBeFound("commentId.equals=" + (commentId + 1));
    }


    @Test
    @Transactional
    public void getAllProfilesByPostIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the profileList where post equals to postId
        defaultProfileShouldBeFound("postId.equals=" + postId);

        // Get all the profileList where post equals to postId + 1
        defaultProfileShouldNotBeFound("postId.equals=" + (postId + 1));
    }


    @Test
    @Transactional
    public void getAllProfilesByMessageIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the profileList where message equals to messageId
        defaultProfileShouldBeFound("messageId.equals=" + messageId);

        // Get all the profileList where message equals to messageId + 1
        defaultProfileShouldNotBeFound("messageId.equals=" + (messageId + 1));
    }


    @Test
    @Transactional
    public void getAllProfilesByFollowedIsEqualToSomething() throws Exception {
        // Initialize the database
        Follow followed = FollowResourceIntTest.createEntity(em);
        em.persist(followed);
        em.flush();
        profile.addFollowed(followed);
        profileRepository.saveAndFlush(profile);
        Long followedId = followed.getId();

        // Get all the profileList where followed equals to followedId
        defaultProfileShouldBeFound("followedId.equals=" + followedId);

        // Get all the profileList where followed equals to followedId + 1
        defaultProfileShouldNotBeFound("followedId.equals=" + (followedId + 1));
    }


    @Test
    @Transactional
    public void getAllProfilesByFollowingIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the profileList where following equals to followingId
        defaultProfileShouldBeFound("followingId.equals=" + followingId);

        // Get all the profileList where following equals to followingId + 1
        defaultProfileShouldNotBeFound("followingId.equals=" + (followingId + 1));
    }


    @Test
    @Transactional
    public void getAllProfilesByBlockeduserIsEqualToSomething() throws Exception {
        // Initialize the database
        Blockuser blockeduser = BlockuserResourceIntTest.createEntity(em);
        em.persist(blockeduser);
        em.flush();
        profile.addBlockeduser(blockeduser);
        profileRepository.saveAndFlush(profile);
        Long blockeduserId = blockeduser.getId();

        // Get all the profileList where blockeduser equals to blockeduserId
        defaultProfileShouldBeFound("blockeduserId.equals=" + blockeduserId);

        // Get all the profileList where blockeduser equals to blockeduserId + 1
        defaultProfileShouldNotBeFound("blockeduserId.equals=" + (blockeduserId + 1));
    }


    @Test
    @Transactional
    public void getAllProfilesByBlockinguserIsEqualToSomething() throws Exception {
        // Initialize the database
        Blockuser blockinguser = BlockuserResourceIntTest.createEntity(em);
        em.persist(blockinguser);
        em.flush();
        profile.addBlockinguser(blockinguser);
        profileRepository.saveAndFlush(profile);
        Long blockinguserId = blockinguser.getId();

        // Get all the profileList where blockinguser equals to blockinguserId
        defaultProfileShouldBeFound("blockinguserId.equals=" + blockinguserId);

        // Get all the profileList where blockinguser equals to blockinguserId + 1
        defaultProfileShouldNotBeFound("blockinguserId.equals=" + (blockinguserId + 1));
    }
