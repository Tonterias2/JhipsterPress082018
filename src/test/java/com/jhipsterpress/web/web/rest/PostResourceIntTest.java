...
public class PostResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllPostsByProfileIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile profile = ProfileResourceIntTest.createEntity(em);
        em.persist(profile);
        em.flush();
        ...
        // Get all the postList where profile equals to profileId
        defaultPostShouldBeFound("profileId.equals=" + profileId);

        // Get all the postList where profile equals to profileId + 1
        defaultPostShouldNotBeFound("profileId.equals=" + (profileId + 1));
    }
