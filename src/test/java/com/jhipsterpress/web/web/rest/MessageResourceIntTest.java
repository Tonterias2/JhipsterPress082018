...
public class MessageResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllMessagesByCommunityIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the messageList where community equals to communityId
        defaultMessageShouldBeFound("communityId.equals=" + communityId);

        // Get all the messageList where community equals to communityId + 1
        defaultMessageShouldNotBeFound("communityId.equals=" + (communityId + 1));
    }


    @Test
    @Transactional
    public void getAllMessagesByProfileIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the messageList where profile equals to profileId
        defaultMessageShouldBeFound("profileId.equals=" + profileId);

        // Get all the messageList where profile equals to profileId + 1
        defaultMessageShouldNotBeFound("profileId.equals=" + (profileId + 1));
    }
