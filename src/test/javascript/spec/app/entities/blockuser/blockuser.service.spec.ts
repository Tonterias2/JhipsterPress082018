    ...
    describe('Blockuser Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/blockusers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Blockuser', () => {
                service.create(new Blockuser(null)).subscribe(received => {
            ...
            it('should update a Blockuser', () => {
                service.update(new Blockuser(123)).subscribe(received => {
