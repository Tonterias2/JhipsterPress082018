    ...
    describe('Community Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/communities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Community', () => {
                service.create(new Community(null)).subscribe(received => {
            ...
            it('should update a Community', () => {
                service.update(new Community(123)).subscribe(received => {
