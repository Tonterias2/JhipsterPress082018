...
describe('Service Tests', () => {
    describe('Calbum Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CalbumService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/calbums';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Calbum', () => {
                service.create(new Calbum(null)).subscribe(received => {
            ...
            it('should update a Calbum', () => {
                service.update(new Calbum(123)).subscribe(received => {
