...
import { CalbumComponent } from 'app/entities/calbum/calbum.component';
import { CalbumService } from 'app/entities/calbum/calbum.service';
import { Calbum } from 'app/shared/model/calbum.model';

describe('Component Tests', () => {
    describe('Calbum Management Component', () => {
        let comp: CalbumComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CalbumComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.calbums[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
